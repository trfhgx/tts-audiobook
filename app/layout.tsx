    ...
    <html lang="en">
      <body className={inter.className}>
        ...
        <div className="fixed inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-400/20 via-purple-300/10 to-pink-400/20"></div>
          ...
          <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-purple-300/15 rounded-full blur-3xl animate-pulse delay-1000"></div>
